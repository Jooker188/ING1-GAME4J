...
public class Board{
    public final int DIM_X = 10;
    public final int DIM_Y = 10;
    private char[][] board;
    private Player p;
    private float taux_obstacles = 0.2f;
    ...
    public void setRandomObstacle(){
        int nbrAbres = Math.round(DIM_X*DIM_Y*taux_bonus)/2; // divise par 2 car 2 types de bonus
        while(nbrAbres > 0){
        ...
        int nbrRocks = Math.round(DIM_X*DIM_Y*taux_bonus)/2;
        while(nbrRocks > 0){
            int caseX = (int) (DIM_X * Math.random());
            int caseY = (int) (DIM_Y * Math.random());
    ...
    public void setRandomBonus(){
        int nbrViande = Math.round(DIM_X*DIM_Y*taux_bonus)/2; // divise par 2 car 2 types de bonus
        while(nbrViande > 0){
            int caseX = (int) (DIM_X * Math.random());
            int caseY = (int) (DIM_Y * Math.random());
        ...
        int nbrFruit = Math.round(DIM_X*DIM_Y*taux_bonus)/2;
        while(nbrFruit > 0){
            int caseX = (int) (DIM_X * Math.random());
            int caseY = (int) (DIM_Y * Math.random());
